...
const StudentList = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(`http://127.0.0.1:8000/authentication/teacher_student/${id}/`);
  ...
  return (
    ...
    <div className="container mx-auto text-center">
      ...
      <h1 className="text-3xl text-white  font-semibold my-8">Students Assigned </h1>
